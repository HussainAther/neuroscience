...
in vitro in many species (Wong, 1999), and shown in vivo using calcium imaging in mouse (Ackman et al., 2012). These waves show both temporal and spatial correlations.
Much work has focused on assessing the role of this activity in the development of the retinotopic map; typically, both the map and various statistics of the activity are compared between wild-type and mutant genotypes. The results are used to make inferences about which features of the activity are implicated in retinotopic map formation (Stafford et al., 2009). There is strong evidence that correlation between neuronal spike times is involved in this process (Xu et al., 2011).
