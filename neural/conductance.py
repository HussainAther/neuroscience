...
"""
Average membrane potential is a subthreshold that's below the spiking threshold. Spikes generated by random fluctations
of the membrane potential over spiking threshold.

Combining higher rates of excitatory and inhibitory neurons, we simulate increasing exchitatory firing rate
balaned by the inhibitory rate so that the mean membrane potential will remain constant.
"""
def calc_fi(fe, v):
    e = np.exp(1)
