...
def train(args, model, device, train_loader, optimizer, epoch):
    '''
    Train the neural network with the arguments of the type of model, the
    torch device, the data loader train_loader, the type of optimizer,
...
for epoch in range(1, args.epochs + 1):
    ...
    end_e=time.time()
    t=end_e-start_e
    print('Time taken for %d th is %d seconds'%(epoch,t))
end=time.time()
print('Time for all the epochs is %d'%(end-start))
